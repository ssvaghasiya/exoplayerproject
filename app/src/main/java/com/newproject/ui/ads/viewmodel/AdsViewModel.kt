package com.newproject.ui.ads.viewmodel
...
class AdsViewModel(application: Application) : BaseViewModel(application) {

    private lateinit var binder: ActivityAdsBinding
    private lateinit var mContext: Context
    lateinit var adapter: AdvertiseAdapter


    fun setBinder(binder: ActivityAdsBinding) {
        this.binder = binder
